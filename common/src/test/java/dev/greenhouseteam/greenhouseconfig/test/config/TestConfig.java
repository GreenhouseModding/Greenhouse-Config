...
public record TestConfig(int silly, HolderSet<Block> redBlocks, HolderSet<Biome> greenBiomes) {
    ...
    public static final TestConfig DEFAULT = new TestConfig(69, new LateHolderSet.Direct<>(Registries.BLOCK, List.of(Blocks.NETHERRACK.builtInRegistryHolder().unwrapKey().get())), new LateHolderSet.Mixed(Registries.BIOME, List.of(GREENS), List.of(Biomes.BAMBOO_JUNGLE)));
